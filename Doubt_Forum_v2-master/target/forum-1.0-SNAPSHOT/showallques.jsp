...
<html>
    ...
    <body>
        ...
        <form action="ViewHomeDetails" method="POST">
             <div class="wrapper wrapper--w900">
            <div class="card card-6">
                <div class="card-heading">
                    
                    <h2 class="title">SHOW ALL QUESTIONS</h2>
                    
                </div>
                <div class="card-body">
                     <div class="form-row">
                    <form method="POST"> 
                        <h1>DOUBTS ASKED PERSONALLY TO TEACHER</h1>
                <table border="1">
              <tr>
              <th>Question-ID</th>
              <th>Question</th>
        ...
        <c:forEach items="${teacherdoubt}" var="item">
               ...
               <c:forEach items="${publicdoubt}" var="item">
